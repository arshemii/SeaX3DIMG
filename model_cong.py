...
def config_generator():
    ...
    cfg.dev.eta_min = 9.3e-6 * cfg.dev.grad_steps # first setup 9e-6
    cfg.dev.mode = 'train'
    cfg.dev.lr = 1.1e-5 * cfg.dev.grad_steps # first setup 1e-5
    ...
    cfg.model.sx3d.checkpoint_exp = './checkpoints_exp/staged_training/disp_obj45.pth'
